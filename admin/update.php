...
<body>
    ...
    <main id="main-container">
        <div id="jumbo">
            ...
            <form id="add-book" action="<?php $_PHP_SELF ?>" method="POST" enctype="multipart/form-data">
                <h1>Update Book</h1>
                <div id="form-grid">
                    <div id="left">
                        <div class="input-form">
                            <label for="title">Book Title</label>
                            <input type="text" name="title" id="title" required autocomplete="off" value="<?= $book['title']; ?>">
                        </div>
                        <div class="input-form">
                            <label for="author">Book Author</label>
                            <input type="text" name="author" id="author" autocomplete="off" required value="<?= $book['author']; ?>">
                        </div>
                        <div class="input-form">
                            <label for="year">Book Year</label>
                            <input type="number" name="year" id="year" autocomplete="off" required min="1800" max="2100" value="<?= $book['year']; ?>">
                        </div>
                    ...
                    <div id="right">
                        <div class="input-form">
                            ...
                            <textarea name="description" id="description" rows="12" required><?= $book['description']; ?></textarea>
                        </div>
                    </div>
                </div>
                <div>
                    <input type="submit" name="update_book" id="submit" value="Update Book">
                </div>
            </form>
        <div id="menu">
